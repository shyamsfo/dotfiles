...
#c.InteractiveShell.banner1 = "Python 3.7.3 (default, Oct 11 2019, 19:39:43) \nType 'copyright', 'credits' or 'license' for more information\nIPython 7.9.0 -- An enhanced Interactive Python. Type '?' for help.\n"
...
class MyPrompt(Prompts):
     def in_prompt_tokens(self, cli=None):
        truncdir = os.getcwd().split(os.sep)[-1:]
        curr_time_str = datetime.datetime.now().strftime('%H:%M')
        return [
            (Token.Prompt, u'IPython '),
            (Token.Prompt, str(curr_time_str)),
            (Token.Prompt, u' '),
